...
#def configure_spark(use_nessie=False, branch="main"):
#    """Configure and initialize Spark session."""
#    iceberg_warehouse_path = "iceberg_warehouse"  # Local Iceberg warehouse path
#
#    # Basic Spark configuration with Iceberg
#    conf = (
#        pyspark.SparkConf()
#        .setAppName("Iceberg Local Warehouse")
#        .set(
#            "spark.jars.packages",
...
#
#    if use_nessie:
#        # Configure Nessie if needed
#        NESSIE_URI = "http://192.168.1.83:19120/api/v1"
#        conf = conf.set(
#            "spark.jars.packages",
#            "org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.5.2,org.projectnessie.nessie-integrations:nessie-spark-extensions-3.5_2.12:0.95.0",
#        ).set(
#            "spark.sql.extensions",
...
#        ).set(
#            "spark.sql.catalog.nessie.ref", branch
#        ).set(
#            "spark.sql.catalog.nessie.authentication.type", "NONE"
#        ).set(
#            "spark.sql.catalog.nessie.catalog-impl", "org.apache.iceberg.nessie.NessieCatalog"
#        ).set(
#            "spark.sql.catalog.nessie.warehouse", iceberg_warehouse_path
#        )
#
...
def configure_spark(provider, branch):
    ...
    NESSIE_URI = "http://192.168.1.82:19120/api/v1"
    WAREHOUSE = "s3a://warehouse/nessie/"
    AWS_S3_ENDPOINT = "http://192.168.1.84:9000"
